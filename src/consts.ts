...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'A real-time data visualization dashboard built with D3.js and React, providing insights into complex datasets with an interactive and responsive interface.',
  ...
  },
  {
    ...
    description: 'A machine learning model deployment platform using Flask and Docker. Allows users to upload, test, and deploy models via a simple REST API.',
    techStack: ['Python', 'Flask', 'Docker', 'PostgreSQL', 'React'],
    githubUrl: 'https://github.com',
  },
  {
    title: 'Nova Static Site Generator',
    description: 'A lightweight and fast static site generator written in Go. Transforms Markdown files into a complete, ready-to-deploy website.',
    ...
    {
    title: 'Aether Wallet',
    description: 'A secure, decentralized cryptocurrency wallet browser extension for the Ethereum blockchain. Features include token management and Web3 integration.',
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    date: '2023-10-26',
    excerpt: 'A deep dive into the modern way of handling asynchronous operations in JavaScript, making your code cleaner and more readable...',
    content: `
        <div>
...
getData().then(console.log); // 'Some Data'</code></pre>
  ...
  },
  {
    ...
    date: '2023-09-15',
    excerpt: 'Learn how to develop reusable UI components in isolation using Storybook, improving your workflow and creating a more robust design system...',
    content: `
        <div>
